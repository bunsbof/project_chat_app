...
const SideDrawer = () => {
  ...
  const { user, setSelectedChat, chats, setChats, discard, setDiscard } = ChatState();
  ...
  return (
    <aside className="w-96">
      <div className="overflow-y-auto py-4 px-3 rounded dark:bg-gray-800">
        ...
        {loadingChat && (
          <div role="status" className="text-3xl">
            <svg
              className="inline mr-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600"
              viewBox="0 0 100 101"
              fill="none"
