...
const Sidebar = () => {
  const { user, discard, setDiscard } = ChatState();
      ...
      <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        ...
        <div className="relative flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
          ...
          <div
            className={`z-10 ${
              dropdown ? "hidden" : ""
            } absolute right-1 text-base list-none bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700`}
          >
