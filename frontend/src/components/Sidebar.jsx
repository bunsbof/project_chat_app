  ...
  return (
    <section className="flex flex-col flex-none overflow-auto w-24 hover:w-64 group lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out ">
                <div className="header p-4 flex flex-row justify-between items-center flex-none">
                    ...
                    <a href="#" className="block rounded-full w-10 h-10 p-2 md:block group-hover:block">
                ...
                <div className="search-box p-4 flex-none">
                    <form>
                        <div className="relative">
                            <label>
                                <input className="rounded-full py-2 pr-6 pl-10 w-full border focus:outline-none text-dark focus:shadow-md transition duration-300 ease-in"
                ...
                <div className="contacts p-2 flex-1 overflow-y-scroll">
                    <div className="flex justify-between items-center p-3 hover: rounded-lg relative">
                        <div className="w-16 h-16 relative flex flex-shrink-0">
